...
use bevy::prelude::*;
use bevy::render::pipeline::UniformProperty::UInt;
...
pub struct MainMenuButtonMaterials {
    pub normal: Handle<ColorMaterial>,
    pub hovered: Handle<ColorMaterial>,
    pub pressed: Handle<ColorMaterial>,
}

/// Called Once to do base initialization
pub fn initialize_mainmenu(mut commands: Commands, mut materials: ResMut<Assets<ColorMaterial>>) {
    trace!("Initialize MainMenu");
    commands.insert_resource(MainMenuButtonMaterials {
...
pub fn setup_mainmenu(
    ...
    button_materials: Res<MainMenuButtonMaterials>,
