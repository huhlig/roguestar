...
use super::PauseMenuButtonMaterials;
use bevy::prelude::*;

/// Pause Menu Tag Component
pub struct PauseMenu;

/// Pause Menu Action Tag
...
pub fn initialize_pausemenu(mut commands: Commands,
                            mut materials: ResMut<Assets<ColorMaterial>>) {
    commands.insert_resource(PauseMenuButtonMaterials {
...
pub fn setup_pausemenu(
    ...
    button_materials: Res<PauseMenuButtonMaterials>,
) {
